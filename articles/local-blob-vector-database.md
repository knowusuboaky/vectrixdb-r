# Local Blob / Vector Database

## Overview

This article explains the **local_blob/vector database** storage layout
...
- `_vectrixdb.db`: local metadata database for collection
  registry/state.

## Script Code: Snapshot Persistence

These functions from `product collections/create_collection.R` control
local blob writes:
